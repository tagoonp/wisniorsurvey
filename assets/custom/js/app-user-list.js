...
function get_user_number(){
    var jxr = $.post(api + 'admin/user?stage=admin_get_user_number', function(){}, 'json')
               .always(function(snap){
                console.log(snap);
                    if(snap.status == 'Success'){
                        $('#divTotalUser').html('<h3 class="mt-3 text-dark mb-0">' + snap.total + ' accounts</h3>')
                        $('#divStaffUser').html('<h3 class="mt-3 text-dark mb-0">' + snap.staff + ' accounts</h3>')
                        $('#divLecturerUser').html('<h3 class="mt-3 text-dark mb-0">' + snap.lecturer + ' accounts</h3>')
                        $('#divStudentUser').html('<h3 class="mt-3 text-dark mb-0">' + snap.student + ' accounts</h3>')
                    }
               })
}