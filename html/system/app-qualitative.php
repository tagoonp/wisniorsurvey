...
>
  <head>
    ...
    <title><?php echo SHORT_TITLE; ?> : Qualitative data</title>
                  ...
                  <div class="col-8">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">รายชื่อชุดข้อมูล</li>
                      </ol>
                    </nav>
                  </div>
                  <div class="col-4 text-right pt-4">
                    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#modalCenter"><i class="bx bx-plus"></i> เพิ่มชุดข้อมูล</button>
                  </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="modalCenterTitle">เพิ่มชุดข้อมูลใหม่</h5>
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" ></button>
                        </div>
                        <div class="modal-body">
                          <div class="row">
                            <div class="col mb-3">
                              <label for="nameWithTitle" class="form-label">ชื่อไฟล์ / ชื่องาน / ID / KEY : <span class="text-danger">*</span></label>
                              <input type="text" id="txtKey" name="txtKey" class="form-control" />
                            </div>
                          </div>
                        </div>
                        <div class="modal-footer">
                          ...
                          <button type="button" class="btn btn-primary" onclick="staff.create_quali_record()">บันทึกและดำเนินการต่อ</button>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card">
                      <div class="card-body">
                        <table class="table table-border-top" id="table-1">
                          ...
                          <tbody>
                            <?php 
                            $strSQL = "SELECT * FROM rsf6x_dataset a INNER JOIN rsf6x_account b ON a.ds_uid = b.uid
                                       WHERE a.ds_delete = 'N' ORDER BY a.ds_udatetime DESC";
                            ...
                            if(($res) && ($res['status'])){
                              ...
                              foreach ($res['data'] as $row) {
                                ...
                                <tr id="tbrow_<?php echo $c;?>" >
                                  <td class="text-top"  style="width: 50px; padding-top-: 17px;"><?php echo $c ; ?> </td>
                                  <td class="text-top"  style=" padding-top-: 17px;">
                                    <?php echo $row['ds_title'] ; ?>
                                    <div>
                                        <small><?php echo $row['ds_detail'] ; ?></small>
                                    </div>
                                  </td>
                                  <td class="text-top" style="">
                                    <?php echo $row['ds_datetime'] ; ?>
                                  </td>
                                  <td class="text-top" style="">
                                    <?php echo $row['ds_udatetime'] ; ?>
                                  </td>
                                  <td class="text-top" style="">
                                    <?php echo $row['fullname'] ; ?>
                                  </td>
                                  <td class="text-top"  style="text-align: right; padding-top: 5px;">
                                      <a href="app-manage-dataset?id=<?php echo $row['ds_id'];?>" class="btn btn-icon"><i class="bx bx-pencil"></i></a>
                                      <a href="Javascript:staff.delete_dataset('<?php echo $row['ds_id'];?>')" class="btn btn-icon"><i class="bx bx-trash text-danger"></i></a>
                                  </td>
                                </tr>
                                <?php
                                $c++;
