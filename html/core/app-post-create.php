...
>
  ...
  <body>
                  ...
                  <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                          <a href="app-post-list">โพส</a>
                        </li>
                        <li class="breadcrumb-item active">สร้างโพสใหม่</li>
                      </ol>
                    </nav>
                  </div>
                  <div class="col-12">
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="form-group col-12">
                            <label for="">ชื่อโพส / หัวข้อ : <span class="text-danger">*</span></label>
                          ...
                          <div class="form-group col-12 col-sm-6">
                            ...
                            <select name="txtRedirect" id="txtRedirect" class="form-control">
                              ...
                              <option value="Y">Redirect</option>
                            </select>
                          </div>
                          ...
                          <div class="form-group col-12">
                            ...
                            <input type="text" name="txtPdf" id="txtPdf" class="form-control">
                          ...
                          <div class="form-group col-12">
                            ...
                            <input type="text" name="txtAlbum" id="txtAlbum" class="form-control" value="">
                            <div class="fw-300 fs-08 pt-1 pl-1">ให้นำ ID ของอัลบัมรูปภาพมาใส่ที่นี่ หรือ <a href="Javascript:openModal('modalAlbum')">- คลิกที่นี่ -</a> เพื่อเลือกอัลบัม</div>
                          </div>

                          <div class="form-group col-12">
                            <label for="">Redirect URL : </label>
                            <input type="text" name="txtRedirectUrl" id="txtRedirectUrl" class="form-control">
                            <div class="fw-300 fs-08 pt-1 pl-1">กรอก URL ที่ต้องการ redirect ไป</div>
                          </div>

                          <div class="form-group col-12 text-right">
                            <button class="btn btn-primary" type="button" onclick="content.create('post')">บันทึก</button>
                          </div>
    ...
    <?php  require_once('./comp/modal_content.php');  ?>
