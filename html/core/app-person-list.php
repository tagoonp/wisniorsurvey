            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <div class="row">
                  ...
                  <div class="col-4 text-right pt-4">
                    <button class="btn btn-primary" type="button" onclick="window.location='app-person-create'"><i class="bx bx-plus"></i> เพิ่มบุคลากร</button>
                  </div>
                  <div class="col-12">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <table class="table table-border-top" id="table-1">
                          ...
                          <tbody>
                            <?php 
                            $strSQL = "SELECT * FROM ecw_person a INNER JOIN ecw_person_group b ON a.per_group_id = b.cat_id 
                                       WHERE a.per_status = 'Y' ORDER BY per_id DESC";
                            ...
                            if(($res) && ($res['status'])){
                              ...
                              foreach ($res['data'] as $row) {
                                ...
                                <tr id="tbrow_<?php echo $c;?>" >
                                  <td class="text-top"  style="width: 50px;"><?php echo $c ; ?> </td>
                                  <td class="text-top" >
                                    <?php echo $row['per_name'] ; ?>
                                  </td>
                                  <td class="text-top"><?php echo $row['cat_name']; ?></td>
                                  <td class="text-top"  style="text-align: right;">
                                      <a href="app-person-edit?id=<?php echo $row['per_id'];?>" class="btn btn-icon"><i class="bx bx-pencil"></i></a>
                                      <a href="Javascript:content.person_delete('<?php echo $row['per_id'];?>')" class="btn btn-icon"><i class="bx bx-trash text-danger"></i></a>
                                  </td>
                                </tr>
                                <?php
                                $c++;
