...
>
  <head>
    ...
    <title>C-Care : รายชื่อสถานบริการ</title>
                  ...
                  <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">รายชื่อสถานบริการ</li>
                      </ol>
                    </nav>
                  </div>
                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header pt-4">
                        <h4>รายชื่อสถานบริการที่อยู่ในระบบ</h4>
                      </div>
                      <div class="card-body">
                            ...
                            if(($res) && ($res['status'])){
                              ...
                              foreach ($res['data'] as $row) {
                                ...
                                <tr id="tbrow_<?php echo $c;?>" >
                                  <td width="80"><?php echo $c;?></td>
                                  <td>
                                    <div class="row">
                                      <div class="col-10">
                                        <span><a href="" style="padding-left: 0px;"><?php echo $row['center_name']; ?></a></span>
                                        <div style="font-size: 0.9em;">
                                          <div style="font-size: 0.8em;" class="text-muted pb-2">UID : <?php 
                                  ...
                                  <td style="text-align: right;">
                                    <a href="app-user-info?center_id=<?php echo $row['center_id'];?>" class="btn btn-icon"><i class="bx bx-search"></i></a>
                                  </td>
                                </tr>
                                <?php
                                $c++;
