...
>
  <head>
    ...
    <title><?php echo SHORT_TITLE; ?> : Media</title>
                  ...
                  <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">สื่อและมีเดีย</li>
                      </ol>
                    </nav>
                  </div>
                </div>
                <div class="card">
                  <div class="card-body">
                    <form action="#" class="dropzone dropzone-area dropzone-previews" id="dpz-single-file-media" style="padding-top: 30px;">
                        <div class="dz-message" style="margin-bottom: 0px; margin-top: 0px;">Click ที่นี่เพื่ออัพโหลดรูปภาพหรือไฟล์<br><span class="text-danger" style="font-size: 0.8em;">ยอมรับไฟล์จำนวนไม่เกิน 10 ไฟล์</span></div>
                    </form>

                    <div class="pt-3">
                    <?php 
                      $strSQL = "SELECT * FROM ecw_media WHERE upload_use = 'Y' ORDER BY upload_id DESC";
