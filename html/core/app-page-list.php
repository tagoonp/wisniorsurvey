                  ...
                  <div class="col-8">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">เพจ</li>
                      </ol>
                    </nav>
                  </div>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <table class="table table-border-top" id="table-1">
                          ...
                          <tbody>
                            <?php 
                            $strSQL = "SELECT * FROM ecw_content WHERE con_type = 'page' AND con_delete = 'N' ORDER BY con_id DESC";
                              ...
                              foreach ($res['data'] as $row) {
                                ...
                                <tr id="tbrow_<?php echo $c;?>" >
                                  ...
                                  <td class="text-top"  style="text-align: right;">
                                      ...
                                      <a href="app-page-edit?id=<?php echo $row['con_id'];?>" class="btn btn-icon"><i class="bx bx-pencil"></i></a>
