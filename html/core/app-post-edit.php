                  ...
                  <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">แก้ไขโพส</li>
                      </ol>
                    </nav>
                  </div>
                  <div class="col-12">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="form-group col-12">
                            ...
                            <input type="text" name="txtAlbum" id="txtAlbum" class="form-control" value="<?php echo $resContent['cont_gallery_id']; ?>">
                          ...
                          <div class="form-group col-12 text-right">
                            <button class="btn btn-primary" type="button" onclick="content.update('post')">บันทึก</button>
                          </div>
