                  ...
                  <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">เพิ่มบุคลากรใหม่</li>
                      </ol>
                    </nav>
                  </div>
                  <div class="col-12">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="form-group col-12">
                            ...
                            <input type="text" name="txtPosittion" id="txtPosition" class="form-control">
                          </div>
                          ...
                          <div class="form-group col-12 text-right">
                            <button class="btn btn-primary" type="button" onclick="content.create_person()">บันทึก</button>
                          </div>
